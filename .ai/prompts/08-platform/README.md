...
| 模块 | 后端提示词 | 前端提示词 | 后端状态 | 前端提示词状态 |
|------|-----------|-----------|---------|--------------|
| 套餐管理 | `backend/package-api.md` | `frontend/0028_package-page.md` | ✅ 已完成 | ⬜ 待重写 |
| 订阅管理 | `backend/subscription-api.md` | `frontend/0029_subscription-page.md` | ✅ 已完成 | ⬜ 待重写 |
| 计费账单 | `backend/billing-api.md` | `frontend/0030_billing-page.md` | ✅ 已完成 | ⬜ 待重写 |
