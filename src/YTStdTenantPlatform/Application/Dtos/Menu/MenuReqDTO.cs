namespace YTStdTenantPlatform.Application.Dtos
{
    ...
    public sealed class CreateMenuReqDTO
    {
    ...
    /// <summary>更新菜单请求</summary>
    public sealed class UpdateMenuReqDTO
    {
        /// <summary>菜单名称</summary>
        public string? Name { get; set; }
        /// <summary>图标</summary>
    ...
    /// <summary>菜单排序请求</summary>
    public sealed class MenuSortReqDTO
    {
        /// <summary>排序号</summary>
        public int SortOrder { get; set; }
    }
