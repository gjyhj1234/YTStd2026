...
// Use json-bigint to parse responses — converts numbers > MAX_SAFE_INTEGER to strings,
// preventing precision loss for snowflake-style long IDs generated by DB.GetNextLongIdAsync().
