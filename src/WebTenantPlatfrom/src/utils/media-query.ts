...
type ScreenChangeHandler = () => void

let handlers: ScreenChangeHandler[] = []
...
export const subscribe = (handler: ScreenChangeHandler): void => {
  handlers.push(handler)
}

export const unsubscribe = (handler: ScreenChangeHandler): void => {
